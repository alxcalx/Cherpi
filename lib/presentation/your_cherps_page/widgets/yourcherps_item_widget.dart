...
class YourcherpsItemWidget extends StatelessWidget {
  YourcherpsItemWidget(this.yourcherpsItemModelObj);

  YourcherpsItemModel yourcherpsItemModelObj;

  var controller = Get.find<YourCherpsController>();
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        yourcherpsItemModelObj.ndnamevalueTxt.value,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtOutfitRegular16WhiteA700,
                      ),
