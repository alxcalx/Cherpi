import '../your_cherps_page/widgets/yourcherps_item_widget.dart';
import 'controller/your_cherps_controller.dart';
import 'models/your_cherps_model.dart';
import 'models/yourcherps_item_model.dart';
...
class YourCherpsPage extends StatelessWidget {
  YourCherpsController controller =
      Get.put(YourCherpsController(YourCherpsModel().obs));
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => ListView.separated(
                          ...
                          itemCount: controller.yourCherpsModelObj.value
                              .yourcherpsItemList.length,
                          itemBuilder: (context, index) {
                            YourcherpsItemModel model = controller
                                .yourCherpsModelObj
                                .value
                                .yourcherpsItemList[index];
                            return YourcherpsItemWidget(
                              model,
                            );
                          },
                        ),
