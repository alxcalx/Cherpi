...
class Listellipsefour1ItemWidget extends StatelessWidget {
  Listellipsefour1ItemWidget(this.listellipsefour1ItemModelObj);

  Listellipsefour1ItemModel listellipsefour1ItemModelObj;

  var controller = Get.find<ReceivedCherpsOneController>();
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        listellipsefour1ItemModelObj.ndnamevalueTxt.value,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtOutfitRegular16WhiteA700,
                      ),
