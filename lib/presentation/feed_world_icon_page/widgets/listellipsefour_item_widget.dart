...
class ListellipsefourItemWidget extends StatelessWidget {
  ListellipsefourItemWidget(this.listellipsefourItemModelObj);

  ListellipsefourItemModel listellipsefourItemModelObj;

  var controller = Get.find<FeedWorldIconController>();
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          listellipsefourItemModelObj.ndnamevalueTxt.value,
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.left,
                          style: AppStyle.txtOutfitRegular16WhiteA700,
                        ),
